...
const {getCategories, getReviews, getSingleReview, getReviewComments, postReviewComment, patchReviewVoteCount, getAllUsers, getReviewQuery} = require('./controllers');
